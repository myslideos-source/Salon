...
**Status: 🟡 teilweise umgesetzt** im Sonderauftrag „Branchenvorlagen und Onboarding-Grundlage" oben — dort aber ausdrücklich auf die Schritte 1–3 (Unternehmen, Branche, Unternehmensdaten) begrenzt beauftragt. `/app/onboarding` existiert bereits mit Fortschrittsanzeige über alle 12 Schritte und Auto-Save, self-service über zwei neue eng gefasste RPCs (nicht über eine breite Phase-4-RLS-Öffnung, da diese für Schritte 1–3 nicht nötig war). Offen bleiben die Schritte 4–12 (Standort, Öffnungszeiten, Team/Ressourcen, Terminarten, Meine Mia, häufige Fragen, Kalender testen, Telefonnummer verbinden, Mia aktivieren) — sie hängen jeweils an ihrer eigenen Fachbereichs-Phase (4, 7–13) und werden dort ergänzt, sobald diese beauftragt werden.
