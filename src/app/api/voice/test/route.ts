...
export async function POST(req: Request) {
  ...
  const systemPrompt = [
    ...
    "Nachdem createAppointment erfolgreich einen Termin gebucht hat, frag danach, ob es sonst noch etwas gibt, womit du helfen kannst. Wenn nein: verabschiede dich freundlich (z. B. 'Tschüss, bis zu deinem Termin!' oder 'Ciao, bis dann!').",
