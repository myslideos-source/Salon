...
import { ClipboardList, UsersRound, Sparkles, ChevronRight } from "lucide-react";
...
const LINKS = [
  ...
  { href: "/app/team", label: TERMINOLOGY.teamAndResources, description: "Mitarbeiter und Abwesenheiten verwalten.", icon: UsersRound },
];
